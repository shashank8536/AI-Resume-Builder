...
export default function FormSection({ formData, onChange, errors = {}, onGenerate, isGenerating, onAIGenerate, isGeneratingAI }) {
      ...
      <form className="space-y-8">
        ...
        <div className="pt-4 border-t border-gray-100 flex flex-col gap-3">
          <button
            ...
            className={`w-full font-bold py-3 px-6 rounded-xl shadow-md transition-all duration-200 flex items-center justify-center gap-2 ${isGeneratingAI ? 'bg-indigo-300 text-white cursor-not-allowed' : 'bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white hover:scale-[1.02]'}`}
          >
            {isGeneratingAI ? "✨ Enhancing Resume via AI..." : "✨ AI Enhance Sections"}
          </button>
